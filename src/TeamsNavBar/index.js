  ...
  return (
    <>
     <div className='mobileNav'>
          <a className='why-text' href='/#mission' >Our Mission</a>
          <a className='how-text'  href='https://t.co/ueDF9WBnuO' >Community</a>
          <a className='road-text'  href='/#roadmap' >Roadmap</a>
        ...
        <Nav id='navbar'>
            ...
            <NavMenu>
                ...
                <NavLinkAnchor style={{padding:'0 20px'}} href="https://t.co/ueDF9WBnuO"  activeStyle>
                    Community
                </NavLinkAnchor>
